...
function test()
  ...
  # Call the solver
  modeldata = FinEtoolsHeatDiffX.AlgoHeatDiffModule.steadystate(modeldata)
  geom=modeldata["geom"]
  Temp=modeldata["temp"]
...
using FinEtools
using FinEtoolsHeatDiffX
using FinEtoolsHeatDiffX.AlgoHeatDiffModule
using Test
function test()
...
function test()
	...
	dt = 2.0/1; # time step
	tend = 20*2.0; # length of the time interval
